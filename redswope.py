...
class night:
    """Class night stores night's attributes.

    Args:
        data-path (str): raw data path
        proc_data_path (str): processed data path (destiny)
        search_pattern (str): pattern for searching images to process
